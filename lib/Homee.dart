...
import 'package:flutterproject/Command.dart';
import 'package:flutterproject/CommandSearchPage.dart';
...
class _HomeeState extends State<Homee> {
  ...
  getontheload() async {
    postsStream = await DatabaseMethods().getUserCommands(userId);
    setState(() {});
  }
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        IconButton(
                                          ...
                                          onPressed: () {
                                            DatabaseMethods().deleteCommand(ds.id);
                                          },
                                        ),
                                      ],
                                    ),
        ...
        actions:[
          IconButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => CommandSearchPage()),
              );
            },
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: const Icon( Icons.logout, color: Colors.black, size: 30.0),
            ),
        ...
        content: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(labelText: 'Enter new phone Number'),
            ),
            TextFormField(
        ...
        actions: [
          ElevatedButton(
            onPressed: () async {
              ...
              await DatabaseMethods().updateCommandDetails(id, updateInfo).then((value) {
